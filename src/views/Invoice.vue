<template>
  ...
  <modal-box v-model="isModalActive" title="Top Up" :submit="postTopUp">
    ...
    <field label="Credit">
      <control v-model="userData.jumlah" name="jumlah" required autocomplete="jumlah" />
    </field>

    <field label="Remark">
      <control v-model="userData.remark" name="remark" required autocomplete="remark" />
    </field>
  </modal-box>
  ...
  <main-section>
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3 mb-6">
      <card-component mb>
        <level mobile>
          <div>
            <h3 class="text-lg leading-tight text-gray-500">Available balance</h3>
...
export default {
  ...
  setup() {
    ...
    onMounted(async () => {
      await store.dispatch("fetchSaldo", { id: route.params.id });
