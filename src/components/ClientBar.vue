<template>
  <nav
    ...
    class="top-0 left-0 right-0 fixed flex bg-white h-14 border-b border-gray-100 z-30 w-screen transition-all xl:pl-4 lg:w-auto lg:items-stretch"
  ...
  >
    <div class="flex-1 items-stretch flex h-14">
      ...
      <nav-bar-item>
        <div class="control">
          <img class="w-20" style="width:'581px;" src="../assets/logo160.png" />
        </div>
      </nav-bar-item>
    </div>
    <!-- <div class="flex-1 items-stretch flex h-14">
